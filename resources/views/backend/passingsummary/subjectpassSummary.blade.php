...
@section('pageContent')
    ...
    <section class="content">
        ...
        <div class="box-inner">
                    <form role="form" id="gradesheet" action="{{ route('subjectpass_postsummary') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label class="control-label" for="section">Subject</label>

                                        <div class="input-group" id="subject">
                                            <span class="input-group-addon"><i class="glyphicon glyphicon-info-sign blue"></i></span>
                            
                                            {{ Form::select('subject_id',$subjects->pluck('name','id')->prepend('Select Subject',""),NULL,['class'=>'form-control select2','required'=>'true'])}}
