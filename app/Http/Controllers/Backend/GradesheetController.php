    ...
    public function printsheet($regiNo,$exam,$class)
    {
       ...
       $student =Registration::where('regi_no','=',$regiNo)
             ...
             $appSettings = AppHelper::getAppSettings();
               ...
               $result =Result::where('class_id',$class)->where('registration_id',$exam)->where('exam_id',$exam)->first(); 
               $mark =Mark::where('class_id',$class)->where('registration_id',$exam)->where('exam_id',$exam)->get();
